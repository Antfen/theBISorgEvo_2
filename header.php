...
<html>
   ...
   <ul id="menu" class="nav">
      <li><a href="associates.php"><span>associates</span></a></li>
      <li><a href="links.php"><span>links</span></a></li>
      <li class="mb-only"><a href="society.php"><span>The Society</span></a></li>
      <li class="mb-only"><a href="advisory-group.php"><span>Advisory Group</span></a></li>
      <li class="mb-only"><a href="code-of-conduct.php"><span>bis Code of conduct</span></a></li>
      <li><a href="contact.php"><span>contact</span></a></li>
   </ul> 

            <div class="logo-holder">
               <a href="index.php"><img class="logo-1" src="images/bis_logo.png" alt="British Inventor's Society"></a>
